...
public final class FragmentCameraBinding implements ViewBinding {
  ...
  @NonNull
  public final Button btnRunBenchmark;
  ...
  private FragmentCameraBinding(@NonNull CoordinatorLayout rootView,
      @NonNull InfoBottomSheetBinding bottomSheetLayout, @NonNull Button btnRunBenchmark,
      @NonNull CoordinatorLayout cameraContainer, @NonNull OverlayView overlay,
      @NonNull PreviewView viewFinder) {
    this.rootView = rootView;
    this.bottomSheetLayout = bottomSheetLayout;
    this.btnRunBenchmark = btnRunBenchmark;
  ...
  public static FragmentCameraBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btn_run_benchmark;
      Button btnRunBenchmark = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentCameraBinding((CoordinatorLayout) rootView, binding_bottomSheetLayout,
          btnRunBenchmark, cameraContainer, overlay, viewFinder);
    }
